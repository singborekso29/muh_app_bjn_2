...
@section('content')
<div class="container">
    <h1><i class="fas fa-edit text-warning"></i> Edit Jadwal Pelajaran</h1>
    <hr>
    ...
    <form action="{{ route('jadwal.update', $jadwal->id) }}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <!-- Kelas -->
                <div class="mb-3">
                    <label><i class="fas fa-school"></i> Kelas <span class="text-danger">*</span></label>
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="ruangan" class="form-control @error('ruangan') is-invalid @enderror" 
                           value="{{ old('ruangan', $jadwal->ruangan) }}" placeholder="Contoh: Ruang 101">
                    @error('ruangan')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="tahun_pelajaran_id" class="form-control @error('tahun_pelajaran_id') is-invalid @enderror" required>
                        ...
                        @foreach($tahunPelajaran as $tp)
                            <option value="{{ $tp->id }}" {{ old('tahun_pelajaran_id', $jadwal->tahun_pelajaran_id) == $tp->id ? 'selected' : '' }}>
